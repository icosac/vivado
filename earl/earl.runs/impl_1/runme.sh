...
HD_PWD='/media/psf/Home/VivadoProjects/earl/earl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log contatore.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source contatore.tcl -notrace
